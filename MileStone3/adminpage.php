        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4" >
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom" style="background: rgba(209,179,102,0.53);">
                ...
                <div class="btn-toolbar mb-2 mb-md-0">
                    <div class="btn-group mr-2">
                        ...
                        <button type="button" class="btn btn-sm btn-outline-secondary">Эспорт</button>
                    </div>
            ...
            <div class="table-responsive" style="background: rgba(209,179,102,0.53);">
                <table class="table table-striped table-sm">
                    ...
                    <tbody>
                    <?php
                    $g_row =  $pdo_conn->query("SELECT db.id,db.name1,db.surname,db.lastname,db.address,db.nationality,db.birthday,s.iin as siin,db.education FROM db_students db JOIN  students s on db.id = s.db_id") ;
                    ...
                    <form action="db/delete.php" method="post">
                        <tr>
                            ...
                            <td><?php echo($row['name1']." ".$row['surname']." ".$row['lastname'])?></td>
                            ...
                            <input type="hidden" name="iin" value="<?=$row['siin']?>">
                    ...
                    $arr_row =  $pdo_conn->query("SELECT db.id,db.name1,db.surname,db.lastname,db.address,db.nationality,db.birthday,s.iin as siin,db.education FROM db_students db JOIN  students s on db.id = s.db_id") ;
